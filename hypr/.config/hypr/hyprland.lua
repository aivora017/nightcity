...
hl.bind("SUPER + X",          hl.dsp.exec_cmd("qs ipc call nc power"))
hl.bind("Print",              hl.dsp.exec_cmd("nc-shot region"))
...
hl.bind("SUPER + M", hl.dsp.exec_cmd("qs ipc call nc media"), { description = "Media controls" })
